...
var Accordion = function Accordion(_ref) {
  ...
  var onToggle = function onToggle(value) {
    if (allowMultiple) {
      if (isOpen.includes(value)) {
        setIsOpen(isOpen.filter(function (number) {
          return number !== value;
        }));
      } else {
        setIsOpen([].concat(_toConsumableArray(isOpen), [value]));
      }
    } else {
      setIsOpen(value);
    }
  ...
  (0, _react.useEffect)(function () {
    ...
    setIsOpen(allowMultiple ? defaultIndex || [] : defaultIndex !== null && defaultIndex !== void 0 ? defaultIndex : null);
    return function () {
      setIsOpen(null);
    };
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
    children: (0, _getChildrenType.getChildrenByType)(children, ['AccordionItem'])
  });
};
...
Accordion.propTypes = {
  ...
  defaultIndex: _propTypes.default.oneOfType([_propTypes.default.array, _propTypes.default.number])
};